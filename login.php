<?php
	...
	/*function*/
	function loginWithFacebook($clientId, $redirectUri)
	{
		$scope = array();
		...
		die(header('Location: https://www.facebook.com/dialog/oauth?'. http_build_query($param)));
	}
	/*xử lý*/
	if(isset($_REQUEST['login_with_facebook'])){
		loginWithFacebook(CLIENT_ID, REDIRECT_URI);
	}
?>
